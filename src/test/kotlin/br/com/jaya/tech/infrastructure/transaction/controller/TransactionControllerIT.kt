...
class TransactionControllerIT : E2ESupport() {
    ...
    fun givenAValidRequest_whenCallCreateCurrencyConversion_shouldReturnConversion(
        ...
        val requestBody =
            readJsonAsString("transaction/create_currency_conversion_request.json")
    ...
    fun givenInvalidCurrencies_whenCallCreateCurrencyConversion_shouldThrowsAnException(
        ...
        val requestBody =
            readJsonAsString("transaction/create_conversion_invalid_currencies_request.json")
                .replace("<<origin>>", originCurrency)
                .replace("<<destination>>", destinationCurrency)

        val exchangeRatesMockResponse =
            readJsonAsString("transaction/invalid_exchange_rates_response.json")
