...
data class Name(
    ...
    companion object {
        ...
        private fun validate(
            ...
            AssertThrows.isTrue(!givenName.isNullOrBlank()) { DomainException.with("'givenName' should not be null or empty") }
            ...
            AssertThrows.isTrue(!familyName.isNullOrBlank()) { DomainException.with("'familyName' should not be null or empty") }
